...
pdf_file1 = current_dir / "../plots_tdsr/fig_ramploading"
...
ax1b.plot((t[nstart:]-t[nstep])/Ta1 , r_tdsr[nstart:]/rinfty1, linewidth=3.5, ls='-', color='red', label=r'TDSR')
...
ax12b.plot((t[nstart:]-t[nstep])/Ta1 , r_tdsr2[nstart:]/rinfty1, linewidth=3.5, ls='-', color='red', label=r'TDSR')
...
ax13b.plot((t[nstart:]-t[nstep])/Ta1 , r_tdsr_ramp[nstart:]/rinfty1, linewidth=3.5, ls='-', color='red', label=r'TDSR')
