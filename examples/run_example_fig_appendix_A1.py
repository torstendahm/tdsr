#--------------------------
# Plot Fig. A1 Appendix -  simulation of trend changes
#--------------------------
import sys
sys.path.insert(0, "../")
from pathlib import Path
from tdsm import Config, TDSM, TDSR1, LCM, Traditional, CFM, RSM , RSD
...
pdf_file1 = current_dir / "../plots/figA1_appendix"
...
loading = TrendchangeLoading(_config=tdsr.config, strend=strend1, strend2=strend2, tstep=tstep, deltat=deltat, tstart=tstart, tend=tend)
config, t, chiz, cf, r, xn = tdsr(loading=loading, chi0=chi0, depthS=depthS, deltaS=deltaS, sigma_max=sigma_max, precision=precision, iX0switch=iX0switch, deltat=deltat, tstart=tstart, tend=tend)
r_tdsr = r
n_tdsr = xn
...
loading = RampLoading(_config=tdsr.config, strend=strend1, strend2=strend2, strend3=strend3, nsample2=nsample2, tstep=tstep, deltat=deltat, tstart=tstart, tend=tend)
config, t, chiz, cf, r, xn = tdsr(loading=loading, chi0=chi0, depthS=depthS, deltaS=deltaS, sigma_max=sigma_max, precision=precision, iX0switch=iX0switch, deltat=deltat, tstart=tstart, tend=tend)
r_tdsr_ramp = r
n_tdsr_ramp = xn
...
loading = RampLoading(_config=rsd.config, strend=strend1, strend2=strend2, strend3=strend3, nsample2=nsample2, tstep=tstep, deltat=deltat, tstart=tstart, tend=tend)
...
loading = TrendchangeLoading(_config=tdsr.config, strend=strend2, strend2=strend1, tstep=tstep, deltat=deltat, tstart=tstart, tend=tend)
config, t, chiz, cf, r, xn = tdsr(loading=loading, chi0=chi0, depthS=depthS, deltaS=deltaS, sigma_max=sigma_max, precision=precision, iX0switch=iX0switch, deltat=deltat, tstart=tstart, tend=tend)
r_tdsr2 = r
n_tdsr2 = xn
...
ax1b.plot((t[nstart:]-t[nstep])/Ta1 , r_tdsr[nstart:]/rinfty1, linewidth=3.5, ls='-.', color='black', label=r'TDSR')
...
ax12b.plot((t[nstart:]-t[nstep])/Ta1 , r_tdsr2[nstart:]/rinfty1, linewidth=3.5, ls='-.', color='black', label=r'TDSR')
...
ax13b.plot((t[nstart:]-t[nstep])/Ta1 , r_tdsr_ramp[nstart:]/rinfty1, linewidth=3.5, ls='-.', color='black', label=r'TDSR')
